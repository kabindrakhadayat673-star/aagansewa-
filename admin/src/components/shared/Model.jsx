        ...
        >
          ...
          <div className="relative bg-white border-b border-gray-100">
            <div className="flex items-center justify-between px-8 py-6">
              ...
              <button
                onClick={onClose}
                className="group p-3 hover:bg-gray-100 rounded-xl transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-red-500/20"
              >
                <FaTimes className="h-5 w-5 text-red-400 group-hover:text-red-600 transition-all duration-500 transform group-hover:rotate-180" />
              </button>
            </div>
          </div>
